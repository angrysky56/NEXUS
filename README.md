...
![License MIT](https://img.shields.io/badge/license-GPL-green.svg)
...
## *Uses uv for dependency management and OpenRouter for LLM access*
...
# Start the server and launch the web interface
./start.sh
```
Go to:
